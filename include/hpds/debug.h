...
HPDS_API void debug_assert_wrn(u32 line, const char* function, const char* file, u64 assertion, ...);
HPDS_API void debug_assert(u32 line, const char* function, const char* file, u64 assertion, ...);
HPDS_API void debug_logv(const char* description, u32 line, const char* function, const char* file, const char* format, va_list args);
HPDS_API void debug_log(const char* description, u32 line, const char* function, const char* file, const char* format, ...);
HPDS_API void debug_log_exit(const char* description, u32 line, const char* function, const char* file, const char* format, ...);
